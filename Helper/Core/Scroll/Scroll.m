...
static void heavyProcessing(CGEventRef event, int64_t scrollDeltaAxis1, int64_t scrollDeltaAxis2, CFTimeInterval tickTS) {
    ...
    MFScrollInversion preliminaryInvertSetting = (inputAxis == kMFAxisHorizontal || _modifications.effectMod == kMFScrollEffectModificationHorizontalScroll) ? _scrollConfig.u_invertHorizontalDirection : _scrollConfig.u_invertDirection;
    MFDirection scrollDirection = [ScrollUtility directionForInputAxis:inputAxis inputDelta:scrollDelta invertSetting:preliminaryInvertSetting horizontalModifier:(_modifications.effectMod == kMFScrollEffectModificationHorizontalScroll)];
...
//            }
    ...
    MFScrollInversion invertSetting = (inputAxis == kMFAxisHorizontal || _modifications.effectMod == kMFScrollEffectModificationHorizontalScroll) ? _scrollConfig.u_invertHorizontalDirection : _scrollConfig.u_invertDirection;
    scrollDirection = [ScrollUtility directionForInputAxis:inputAxis inputDelta:scrollDelta invertSetting:invertSetting horizontalModifier:(_modifications.effectMod == kMFScrollEffectModificationHorizontalScroll)]; /// Why do we need to get the scrollDirection again? We already calculated it during the "preliminary scrollAnalysis". Can it ever change betweent he 2 times we calculate it?
